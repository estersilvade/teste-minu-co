...
const cadastroDeProduto = async(req, res) => {
  const { nomeDoProduto, quantidade,valorProdutoUnidade,valorDaNota,numeroDaNota, nomeDofornecedor,cnpjFornecedor,produtoEmEstoque}= req.body
  try{
...
const editList = async (req, res) =>{
  ...
  try{
     ...
     const{nomeDoProduto, quantidade,valorProdutoUnidade,valorDaNota,numerDaNota,nomeDofornecedor ,  cnpjFornecedor,produtoEmEstoque}= req.body
     ...
     alterarDados.produtoEmEstoque = produtoEmEstoque || produtoEmEstoque
